...
public class MembersController {
	...
	@PreAuthorize("hasAnyRole('ADMIN', 'USER') and principal.username == #memberEmail")
	...
	@org.springframework.data.repository.query.Param("memberEmail") String memberEmail,  @AuthenticationPrincipal PrincipalDetails principal ){
